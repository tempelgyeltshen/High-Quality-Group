...
async function startServer() {
  ...
  try {
    await initDatabase();
    console.log('Firestore database collections verified and seeded successfully.');
  } catch (err) {
  ...
  // User Management endpoints (Restricted: for Admin to manage cashiers securely)
  ...
  // Get a single sale's details including items
  ...
  // Get aggregated report data for Day End panel
